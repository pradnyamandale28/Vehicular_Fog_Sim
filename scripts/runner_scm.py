"""
SCM Load Sweep Runner
Runs SCM scheme across load range with multiple repetitions
"""
...
import os
import sys
from Schemes.SCM_v1 import start_sumo, run_scm
...
def main():
    parser = argparse.ArgumentParser(description="SCM load sweep experiment")
    ...
    parser.add_argument("--output", type=str, default="results/scm_logs_new.csv",
    ...
    print("=" * 60)
    print("SCM Load Sweep Experiment")
    print("=" * 60)
    ...
    for load in loads:
        for rep in range(args.runs):
            ...
            try:
                ...
                metrics = run_scm(load=load, run_id=run_idx, seed=seed, gui=args.gui)
    ...
    print("\n" + "=" * 60)
    print("SCM Experiment Completed!")
